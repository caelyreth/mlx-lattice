...
inline float4 load_dense_weight_ci4(
    ...
    return float4(
        float(weights[co * weight_s0 + kernel_id * channels + ci_base + 0]),
        float(weights[co * weight_s0 + kernel_id * channels + ci_base + 1]),
        float(weights[co * weight_s0 + kernel_id * channels + ci_base + 2]),
        float(weights[co * weight_s0 + kernel_id * channels + ci_base + 3])
    );
}
