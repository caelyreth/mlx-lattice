...
class SparseConvFeatures final : public SparsePrimitive {
  public:
    ...
    void eval_gpu(
        ...
        backend::gpu::conv::eval(shape_, stream(), inputs, outputs);
    }
...
class SparseConvFeaturesInputGrad : public SparsePrimitive {
  public:
    ...
    void eval_gpu(
        ...
        backend::gpu::conv::eval_input_grad(shape_, stream(), inputs, outputs);
    }
...
class SparseConvFeaturesWeightGrad final : public SparseConvFeaturesInputGrad {
  public:
    ...
    void eval_gpu(
        ...
        backend::gpu::conv::eval_weight_grad(shape_, stream(), inputs, outputs);
    }
