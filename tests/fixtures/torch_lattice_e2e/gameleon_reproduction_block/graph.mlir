module attributes {
  ...
  func.func @forward(
    ...
    %encoder_weight = lattice.weight @encoder_weight {storage_key = "encoder.weight", layout = #lattice.weight_layout<conv3d_o_zyx_i>, packing = #lattice.packing<dense>} : !lattice.weight<conv3d, f32>
    ...
    %context_weight = lattice.weight @context_weight {storage_key = "context.weight", layout = #lattice.weight_layout<conv3d_o_zyx_i>, packing = #lattice.packing<dense>} : !lattice.weight<conv3d, f32>
    ...
    %learned_up_weight = lattice.weight @learned_up_weight {storage_key = "learned_up.weight", layout = #lattice.weight_layout<conv3d_o_zyx_i>, packing = #lattice.packing<dense>} : !lattice.weight<conv3d, f32>
    ...
    %output_weight = lattice.weight @output_weight {storage_key = "output.weight", layout = #lattice.weight_layout<conv3d_o_zyx_i>, packing = #lattice.packing<dense>} : !lattice.weight<conv3d, f32>
