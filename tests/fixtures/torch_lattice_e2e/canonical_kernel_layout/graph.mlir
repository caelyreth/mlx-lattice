module attributes {
  ...
  func.func @forward(
    ...
    %conv = lattice.subm_conv3d %x, %conv_weight {kernel_size = array<i64: 3, 1, 5>, dilation = array<i64: 1, 1, 1>} : (!lattice.sparse_tensor<rank = 3, coord = batch_x_y_z, feature = row_channel, dtype = f32>, !lattice.weight<conv3d, f32>) -> !lattice.sparse_tensor<rank = 3, coord = batch_x_y_z, feature = row_channel, dtype = f32>
